                ...
                <div className="container">
                    <div className="navbar-header">
                        <Link className="navbar-brand" to="/account">
                            <img className="navbar-logo" src="/public/media/si-logo-03.png" />
                            <span className="navbar-brand-label">ShareIntro</span>
                        </Link>
                        <button
...
{/*                            <li className={this.classForPath('/account')}>
                            ...
                            <li className={this.classForPath('/account/profile')}>
